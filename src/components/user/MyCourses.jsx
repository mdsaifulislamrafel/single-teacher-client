      ...
      subcategories: [
        {
          ...
          videos: [
            { id: 1001, title: "ভাষার উৎপত্তি", duration: "10:25", vdoCipherId: "5df847fa8a684093bedda6a684eeee51" },
            { id: 1002, title: "ভাষার বিবর্তন", duration: "8:15", vdoCipherId: "sample-id-1002" },
            { id: 1003, title: "বাংলা ভাষার ইতিহাস", duration: "12:40", vdoCipherId: "sample-id-1003" },
            { id: 1004, title: "বাংলা ভাষার বিভিন্ন রূপ", duration: "9:30", vdoCipherId: "sample-id-1004" },
            { id: 1005, title: "বাংলা ভাষার ব্যাকরণ", duration: "15:20", vdoCipherId: "sample-id-1005" },
          ],
        },
        {
          id: 102,
          ...
          videos: [
            { id: 1006, title: "বর্ণ পরিচয়", duration: "7:55", vdoCipherId: "sample-id-1006" },
            { id: 1007, title: "শব্দ গঠন", duration: "11:30", vdoCipherId: "sample-id-1007" },
            { id: 1008, title: "বাক্য গঠন", duration: "13:45", vdoCipherId: "sample-id-1008" },
            { id: 1009, title: "ক্রিয়া পদ", duration: "9:20", vdoCipherId: "sample-id-1009" },
            { id: 1010, title: "বিশেষ্য ও বিশেষণ", duration: "10:15", vdoCipherId: "sample-id-1010" },
          ],
        },
      ],
    },
      ...
      subcategories: [
        {
          ...
          videos: [
            { id: 2001, title: "Parts of Speech", duration: "12:10", vdoCipherId: "sample-id-2001" },
            { id: 2002, title: "Tense", duration: "14:25", vdoCipherId: "sample-id-2002" },
            { id: 2003, title: "Articles", duration: "8:30", vdoCipherId: "sample-id-2003" },
            { id: 2004, title: "Prepositions", duration: "11:15", vdoCipherId: "sample-id-2004" },
          ],
        },
        {
          id: 202,
          ...
          videos: [
            { id: 2005, title: "Essay Writing", duration: "15:40", vdoCipherId: "sample-id-2005" },
            { id: 2006, title: "Letter Writing", duration: "13:20", vdoCipherId: "sample-id-2006" },
            { id: 2007, title: "Report Writing", duration: "16:05", vdoCipherId: "sample-id-2007" },
          ],
        },
      ],
    },
            ...
            {selectedVideo ? (
              ...
              >
                ...
                <div className="aspect-video bg-black relative">
                  {/* This would be replaced with actual VdoCipher implementation */}
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-white text-center">
                      <p className="mb-2">VdoCipher Player</p>
                      <p className="text-sm text-gray-300">Video ID: {selectedVideo.vdoCipherId}</p>
                      <div className="mt-4 bg-blue-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto">
