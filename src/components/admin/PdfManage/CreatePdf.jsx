          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="mt-6">
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600">
                ...
                <li>
                  Select the correct category and subcategory before uploading
                </li>
                <li>Set an appropriate price for your PDF</li>
                <li>
                  Provide a clear title and description to help users find your
                  content
                </li>
              </ul>
            </div>
            ...
            {success && (
              <div className="mt-6 p-4 bg-green-100 text-green-700 rounded-md">
                ...
                <p className="text-sm mt-1">
                  Your PDF has been processed and is now available.
                </p>
              </div>
            )}
          </div>
